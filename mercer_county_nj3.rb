...
class Property  < Way
  ...
  def cleanup
    ...
    #"data:municipality"=>"TRENTON CITY", "data:block"=>"34002", "data:lot"=>"5", "data:qcode"=>"", "data:mun"=>"1111", "data:pams_pin"=>"1111_34002_5",
...
#      "&where=upper(ADD)%20Like%20%27%25" + qry + "%25%27" +
      "&where=PAMS_PIN%20Like%20%27%25" + qry + "%25%27" +
      "&returnGeometry=true"    +
      "&f=json" +
      "&outSR=4326" +
      "&outFields=*" # + fieldstr 
